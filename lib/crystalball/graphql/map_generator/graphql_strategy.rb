    ...
    module MapGenerator
      ...
      class GraphQLStrategy
        ...
        class << self
          ...
          # the patch to it. Otherwise, raises error.
          def apply_patch!
            raise_undefined_graphql_error unless defined?(::GraphQL::Schema)
          ...
          def raise_undefined_graphql_error
            raise(
              NameError,
          ...
          def add_definition_paths(object_id, paths)
            type_definition_paths[object_id] ||= []
            type_definition_paths[object_id]  |= paths
          end
        end
        ...
        def tracer
          @tracer ||= TracePoint.new(:call) do |tp|
            ...
            self.class.add_definition_paths(this.object_id, paths)
          end
        end
      end
    end
